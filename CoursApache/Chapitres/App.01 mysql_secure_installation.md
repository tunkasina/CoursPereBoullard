...
Voici toutes les interrogations du script et leur signification:
 ...
 - `Change the root password? [Y/n]` : Attention, le script ment. Votre compte root n'est pas protégé du tout. Définissez ici un mot de passe **root** pour le serveur _mariadb_.
